...
const ProjectCard = ({
  ...
  const optionsTilt = {
    ...
    max: isMobile ? 7 : 30, // max tilt rotation (degrees)
    perspective: isMobile ? 1800 : 1300, // Transform perspective, the lower the more extreme the tilt gets.
    scale: 1, // 2 = 200%, 1.5 = 150%, etc..
    speed: isMobile ? 400 : 1000, // Speed of the enter/exit transition
