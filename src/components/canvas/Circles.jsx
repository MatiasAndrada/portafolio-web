...
// Create circles
const createCircles = () => {
  const numCircles = Math.floor(canvas.width * canvas.height / 100000); // Adjust density of circles
  circles.length = 0;
  for (let i = 0; i < numCircles; i++) {
    ...
    if (i % 2 === 0) {
      dx /= 4; // Reduce horizontal speed for every second circle
      dy /= 4; // Reduce vertical speed for every second circle
    }
